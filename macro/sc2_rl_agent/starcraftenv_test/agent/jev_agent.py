...
TERRAN_INSTRUCTIONS = (
    ...
    "Each train/build/add-on/morph choice starts one unit or structure; with 600 or more "
    "minerals banked, a Marine, Marauder, Siege Tank or Medivac choice fills every free "
    "producer that can make it. Marauders, "
