...
| T15 | CheatVision | Defeat | 17:01 | 2.97M | Reinforcements gather before joining an attack; army-mix guidance; 30-minute limit (restarted phase 2, game 1, **Ancient Cistern LE**; commit `2ca1641`) |
...
| T15 | CheatVision | 负 | 17:01 | 297 万 | 新单位集结后再加入进攻；兵种比例建议；30 分钟时限（重新计数的第 2 阶段第 1 局，**Ancient Cistern LE**；提交 `2ca1641`） |
